...
public class ControllerGame : MonoBehaviour
{
    ...
    public SpriteRenderer[] barraItems = new SpriteRenderer[3];
    ...
    public void establishCorrectButton()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            if (ran == i)
            {
                ...
                barraItems[i].tag = "Correcto";
                items[i].sprite = correctImage;
            }
            else {
                items[i].tag = "Incorrecto";
                barraItems[i].tag = "Incorrecto";
            ...
            // barraItems[i].transform.localScale = new Vector3(12, Screen.height, 0);
        }
    }
}